...
implementations for both rolling sums and full movement dynamics extraction:
...
bench |> dplyr::group_by(task, method) |> dplyr::summarise(median_sec = median(elapsed_sec))
